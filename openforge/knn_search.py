...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_neighbors", type=int, default=5, help="Number of neighbors to return for nearest neighbor search")
    ...
    log_dir = os.path.join(
        args.log_dir,
        f"{arts_output_id}_num_head_concepts-{args.num_head_concepts}_knn_search"
    )
