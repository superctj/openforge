"""
Inference using a LLM on ICPSR dataset.
"""
...
def get_llm_prediction(
    ...
    pred, confdc_score = parse_llm_response(response, keyword="parent-child")
...
if __name__ == "__main__":
    ...
    valid_input_filepath = os.path.join(input_dir, "validation.json")
    test_input_filepath = os.path.join(input_dir, "test.json")
