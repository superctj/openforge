...
from openforge.utils.mrf_common import (
    ...
    evaluate_two_stage_inference_results,
)
...
class TwoStageTuningEngine:
    def __init__(
        self, exp_config, mrf_wrapper, mrf_hp_space, stage
    ):
        self.exp_config = exp_config
        self.mrf_wrapper = mrf_wrapper
        self.mrf_hp_space = mrf_hp_space
    ...
    def bo_target_function(self, mrf_hp_config: ConfigurationSpace, seed: int):
        ...
        f1_score, accuracy, _, _ = evaluate_two_stage_inference_results(
            self.mrf_wrapper.prior_data, results, stage=self.stage
        )
